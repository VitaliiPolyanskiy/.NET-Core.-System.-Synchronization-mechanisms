...
namespace Synchronization_mechanisms
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        ManualResetEvent manualevent = new ManualResetEvent(false); // событие с ручным сбросом в несигнальном состоянии
        ...
        void Thread(Object obj)
        {
            ...
            manualevent.Reset(); // переводим событие в несигнальное состояние
        }
        ...
        {
            manualevent.Set(); // переводим событие в сигнальное состояние и отпускаем все ждущие потоки
        }
